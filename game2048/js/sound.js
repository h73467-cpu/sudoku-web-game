// Tiny Web Audio synth for 2048's move/merge/invalid/undo/win/lose sounds —
// no audio files, same zero-dependency approach as minesweeper/js/sound.js.
...
var Game2048Sound = (function () {
  ...
  function play(event) {
    ...
    switch (event) {
      case "move":
        beep(340 + Math.random() * 40, 0.06, "triangle", 0.16);
        break;
      case "invalid":
...
if (typeof window !== "undefined") {
  window.Game2048Sound = Game2048Sound;
}
if (typeof module !== "undefined" && module.exports) {
  module.exports = Game2048Sound;
}
