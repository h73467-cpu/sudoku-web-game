// Tiny Web Audio synth for othello's place/pass/undo/win/draw sounds — no
// audio files, same zero-dependency approach as connectFour/js/sound.js.
...
var OthelloSound = (function () {
  ...
  function play(event) {
    ...
    switch (event) {
      case "place":
        beep(300 + Math.random() * 50, 0.08, "triangle", 0.2);
        break;
      case "invalid":
        beep(140, 0.12, "sawtooth", 0.18);
        break;
      case "pass":
        beep(220, 0.1, "square", 0.14);
        break;
      case "undo":
...
if (typeof window !== "undefined") {
  window.OthelloSound = OthelloSound;
}
if (typeof module !== "undefined" && module.exports) {
  module.exports = OthelloSound;
}
