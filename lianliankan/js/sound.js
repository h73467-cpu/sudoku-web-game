// Tiny Web Audio synth for lianliankan's select/match/invalid/hint/undo/
// reshuffle/win sounds — no audio files, same zero-dependency approach as
// jigsaw/js/sound.js. Kept as its own independent copy (not shared) to
// match this codebase's existing convention of small per-game duplication
// over cross-game coupling.
var LianliankanSound = (function () {
  let ctx = null;
  let enabled = true;
  ...
  function play(event) {
    ...
    switch (event) {
      ...
      case "undo":
        ...
        break;
      case "reshuffle":
        beep(220 + Math.random() * 80, 0.1, "triangle", 0.16);
        break;
      case "win":
...
if (typeof window !== "undefined") {
  window.LianliankanSound = LianliankanSound;
}
if (typeof module !== "undefined" && module.exports) {
  module.exports = LianliankanSound;
}
